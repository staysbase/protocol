...
import "./StaysBASETokenMonetaryPolicy.sol";


/**
 * @title StaysBASETokenOrchestrator
 * @notice The orchestrator is the main entry point for rebase operations. It coordinates the policy
 * actions with external consumers.
 */
contract StaysBASETokenOrchestrator is OwnableUpgradeSafe {
    ...
    StaysBASETokenMonetaryPolicy public policy;

    function setMonetaryPolicy(address _policy)
        public
        onlyOwner
    {
        policy = StaysBASETokenMonetaryPolicy(_policy);
    }

    /**
     * @param policy_ Address of the StaysBASEToken policy.
     */
    ...
    {
        __Ownable_init();
        policy = StaysBASETokenMonetaryPolicy(policy_);
    }

    /**
     * @notice Main entry point to initiate a rebase operation.
     *         The StaysBASETokenOrchestrator calls rebase on the policy and notifies downstream applications.
