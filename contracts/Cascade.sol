...
contract Cascade is OwnableUpgradeSafe {
    ...
    event Withdraw(address indexed user, uint256 lpTokens, uint256 staysBASETokens, uint256 timestamp);
    ...
    function setBASEToken(address _staysBASEToken)
        public
        onlyOwner
    {
        StaysBASE = StaysBASEToken(_staysBASEToken);
    }
        ...
        onlyOwner
    {
        ...
        bool ok = StaysBASE.transfer(recipient, amount);
        require(ok, "transfer");
    }
        ...
        public
    {
        ...
        require(StaysBASE.balanceOf(address(this)) >= owed, "available tokens");
        ...
        require(ok, "transfer");
        ok = StaysBASE.transfer(msg.sender, owed);
        require(ok, "transfer");
    ...
    function rewardsPool()
        ...
        returns (uint256)
    {
        uint256 baseBalance = StaysBASE.balanceOf(address(this));
        uint256 unlocked;
